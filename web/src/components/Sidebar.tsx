...
export function Sidebar({ user }: SidebarProps) {
    ...
    const navItems = [
        ...
        { path: '/dashboard/assistants', label: 'Assistenten', icon: '🤖', svgPath: 'M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z' },
        { path: '/dashboard/projects', label: 'Projekte', icon: '📂', svgPath: 'M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2zM9 12h6M9 16h6' },
